...
<main>
    ...
    <section class="breadcrumb__area include-bg pt-150 pb-150 breadcrumb__overlay" data-background="{{ asset('storage/' . $course->breadcrum_image) }}">
        <div class="container">
            <div class="row">
                        ...
                        <div class="course__meta-2 d-sm-flex align-items-center mb-30">
                            <div class="course__teacher-3 d-flex align-items-center mr-70 mb-30">
                                ...
                                <div class="course__teacher-info-3">
                                    <h5>Teacher</h5>
                                    <p><a href="#">{{ $course->teacher->surname . ' ' . $course->teacher->first_name . ' ' . $course->teacher->last_name }}</a>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="course__tab-2 mb-45">
                            <ul class="nav nav-tabs" id="courseTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description" type="button" role="tab" aria-controls="description" aria-selected="true"><i class="fa-regular fa-medal"></i> <span>Description</span> </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#review" type="button" role="tab" aria-controls="review" aria-selected="false"> <i class="fa-regular fa-star"></i> <span>Reviews</span>
                                    </button>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content" id="courseTabContent">
                                <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                    <div class="course__description">
                                        ...
                                        <div class="course__description-list mb-45">
                                            ...
                                            <ul>
                                                {!! str_replace('<li>', '
                                                <li> <i class="fa-solid fa-check"></i>', $course->qualifications) !!}
                                            </ul>
                                        </div>
                                        @endif
                                        @if ($course->duration)
                                        <div class="course__description-list mb-45">
                                            ...
                                            <ul>
                                                {!! str_replace('<li>', '
                                                <li> <i class="fa-solid fa-check"></i>', $course->duration) !!}
                                            </ul>
                                        </div>
                                        @endif
                                        ...
                                        <div class="accordion" id="course__accordion">
                                            <div class="accordion-item mb-50">
                                                <h2 class="accordion-header" id="{{ $topic['topic_code'] }}">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#{{ $topic['topic_code'] }}-content" aria-expanded="true" aria-controls="{{ $topic['topic_code'] }}-content">

                                                        {{ $topic['topic_code'] . ' - ' . $topic['topics'] }}
                                                    </button>
                                                </h2>
                                                <div id="{{ $topic['topic_code'] }}-content" class="accordion-collapse collapse show" aria-labelledby="{{ $topic['topic_code'] }}" data-bs-parent="#course__accordion">
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="course__curriculum-content d-sm-flex justify-content-between align-items-center">
                                                            ...
                                                            <div class="course__curriculum-meta">
                                                                <span class="question">{{ $subTopic['duration'] . ' minutes' }}</span>
                                                            </div>
                                                            @endif
                                                        </div>
                                                        @endforeach
                                                            ...
                                                            <div class="course__form-input">
                                                                <div class="course__form-rating">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="#" class="no-rating"> <i class="fa-solid fa-star"></i> </a>
                                                                        </li>
                                                                        <li><a href="#" class="no-rating"> <i class="fa-solid fa-star"></i> </a>
                                                                        </li>
                                                                    </ul>
                                ...
                                <div class="course__share">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#" class="pin"><i class="fa-brands fa-instagram"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="course__sidebar-widget-2 white-bg mb-20">
                            <div class="course__video">
                                <div class="course__video-thumb w-img mb-25">
                                    <img src="{{ asset('assets/img/course/video/course-video.jpg') }}" alt="">
                                ...
                                <div class="course__payment mb-35">
                                    <h3>Payment:</h3>
                                    <a href="#">
                                        <img src="{{ asset('assets/img/course/payment/payment-1.png') }}" alt="">
                                    </a>
                                </div>
