                                        ...
                                        <div class="course__description">
                                            ...
                                            @if ($course->qualifications)
                                                <div class="course__description-list mb-45">
                                                    ...
                                                    <ul>
                                                        {!! str_replace('<li>', '<li> <i class="fa-solid fa-check"></i>', $course->qualifications) !!}
                                                    </ul>
                                                </div>
                                            @endif
                                            @if ($course->duration)
                                                <div class="course__description-list mb-45">
                                                    ...
                                                    <ul>
                                                        {!! str_replace('<li>', '<li> <i class="fa-solid fa-check"></i>', $course->duration) !!}
                                                    </ul>
                                                </div>
                                            @endif
                        ...
                        <div class="course__popup-wrapper p-relative">
                            ...
                            <div class="course__popup-top d-flex align-items-start mb-40">
                                <div class="course__popup-thumb mr-20">
                                    <img src="{{ asset('assets/img/course/course-sm-1.jpg') }}" alt="">
                                </div>
                                    ...
                                    <div class="row gx-3">
                                        ...
                                        <div class="col-xxl-12">
                                            <div class="course__popup-btn">
                                                <button type="submit" class="tp-btn w-100">Pay Rs. 3000.00</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
