                  ...
                  <div class="row align-items-center">
                     <div class="col-xxl-6 col-xl-8 col-lg-8 col-md-8">
                        <div class="header__info">
                           <ul>
                              <li>
                                 <a href="mailto:info@medexcollege.com"> 
                                    ...
                                    </svg> <span>info@medexcollege.com</span></a>
                              </li>
                              <li>
                     ...
                     <div class="col-xxl-6 col-xl-4 col-lg-4 col-md-4">
                        <div class="header__top-right d-flex justify-content-end align-items-center">
                           <div class="header__login">
                              <a href="https://moodle.medexcollege.com/login/index.php"><svg viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <div class="header__btn ml-20">
                              <a href="{{ route('contact') }}" class="header-btn">contact us</a>
                           </div>
                        </div>
                     </div>
                  </div>
                            ...
                            <ul>
                               <li class="d-flex align-items-center">
                                  ...
                                  <div class="offcanvas__contact-text">
                                     <a target="_blank" href="#">Medex College</a>
                                  </div>
                               </li>
                               <li class="d-flex align-items-center">
                                  <div class="offcanvas__contact-icon mr-15">
                                  ...
                                  <div class="offcanvas__contact-text">
                                     <a href="tel:0712142144">0712142144</a>
                                  </div>
                               </li>
                               <li class="d-flex align-items-center">
                                  <div class="offcanvas__contact-icon mr-15">
                                  ...
                                  <div class="offcanvas__contact-text">
                                     <a href="mailto:info@medexcollege.com"><span class="__cf_email__" >info@medexcollege.com</span></a>
                                  </div>
                               </li>
                            </ul>
                         </div>
